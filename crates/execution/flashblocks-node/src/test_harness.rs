...
impl EthgasNodeExtension for FlashblocksTestExtension {
...
impl FlashblocksHarness {
    ...
    async fn with_options(process_canonical: bool) -> Result<Self> {
        ...
        // Create harness by building it directly
...
/// Test harness builder for building flashblocks with manual canonical control.
#[derive(Debug)]
...
impl FlashblocksBuilderTestHarness {
    ...
    pub async fn new_canonical_block(&mut self, user_transactions: Vec<TransactionSigned>) {
