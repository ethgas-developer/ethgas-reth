...
pub enum ExtendedSubscriptionKind {
    ...
    /// Ethgas-specific subscription types for flashblocks.
    Ethgas(EthgasSubscriptionKind),
}

/// Ethgas-specific subscription types for flashblocks.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub enum EthgasSubscriptionKind {
...
impl From<EthgasSubscriptionKind> for ExtendedSubscriptionKind {
    fn from(kind: EthgasSubscriptionKind) -> Self {
        Self::Ethgas(kind)
    }
}
