...
pub type EthNodeTypes = FullNodeTypesAdapter<EthereumNode, DatabaseEnv, EthProvider>;

/// A [`BlockchainProvider`] instance.
pub type EthProvider = BlockchainProvider<NodeTypesWithDBAdapter<EthereumNode, DatabaseEnv>>;
