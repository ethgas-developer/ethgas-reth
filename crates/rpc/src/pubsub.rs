...
//! and Ethgas-specific flashblocks subscriptions (newFlashblocks, pendingLogs).
...
use ethgas_reth_flashblocks::traits::FlashblocksAPI;
use jsonrpsee::{
...
use crate::types::{EthgasSubscriptionKind, ExtendedSubscriptionKind};
...
/// both standard Ethereum subscriptions and Ethgas-specific flashblocks subscriptions.
...
pub trait EthPubSubApi {
    ...
    /// as well as Ethgas-specific subscriptions (newFlashblocks, pendingLogs).
    #[subscription(
...
/// and Ethgas-specific flashblocks subscriptions.
#[derive(Clone, Debug)]
    ...
    FB: FlashblocksAPI + Send + Sync + 'static,
{
    ...
    async fn subscribe(
        ...
        let ExtendedSubscriptionKind::Ethgas(ethgas_kind) = kind else {
        ...
        match ethgas_kind {
            EthgasSubscriptionKind::NewFlashblocks => {
            ...
            EthgasSubscriptionKind::PendingLogs => {
            ...
            EthgasSubscriptionKind::NewFlashblockTransactions => {
